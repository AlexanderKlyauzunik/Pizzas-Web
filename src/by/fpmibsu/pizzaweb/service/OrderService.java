...
<<<<<<< HEAD:src/by/fpmibsu/pizzaweb/Dao/DaoImpl/OrderDaoImpl.java
                while (resultSet2.next())
...
=======
            ...
            while (resultSet1.next())
                drinks.add(new DrinkService().findEntityById(resultSet1.getLong("DrinkID")));
>>>>>>> parent of 09c05fd... Rename some packages and classes:src/by/fpmibsu/pizzaweb/service/OrderService.java
